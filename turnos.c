...
int cuantosJugadores(){
    int jugadores = 0;
    do{
        printf("\nSelecciona jugadores (2 a 4)\n [!] SI HAS GUARDADO ANTES, SELECCIONA EL MISMO NO. DE JUGADORES [!]\n>>" );
        scanf("%d", &jugadores);
...
//---- Funcion inutil por la implementacion de board, pero como nos acompaño en el camino aqui se queda, la memoria es gratis XDDDDDDD
...
} //Inicia editor custom de la partida.
